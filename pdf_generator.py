...
def generar_pdf(
    ...
    def later_pages(canvas, doc):
        if doc.page == 2:
            ...
            header_footer(canvas, doc)
            draw_texto_mixto(canvas, 45, A4[1] - 290, "Frente a lo anterior, esta metodología permitió la identificación de", causas_identificadas, "causas, directamente relacionadas con los", factores_micmac, "factores priorizados en la Mic-Mac.")
